...
const DocumentTitle: FC<DocumentTitleProps> = memo(({title, description, image}): JSX.Element | null => {
    ...
    const finalDescription = useMemo(() => {
        return (
            description ||
            'Explore online catalog of a celebrity artwork, learn details about each work as well as history about celebrity. Add artwork you own into your collection management.'
        );
    }, [description]);
